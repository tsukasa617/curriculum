...
<div class="container">
    ...
    <div>
        <span style="font-size: 30px;">顧客ステータス編集</span><br>
        ...
        <ul class="sub_menu">
            ...
            <div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="label1" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    ...
                    <form action="{{ action('ClientController@client_status_add') }}" method="POST">
                    {{ csrf_field() }}
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="modal fade" id="upd_modal<?php print "$i" ?>" tabindex="-1" role="dialog" aria-labelledby="label1" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form action="{{ action('ClientController@client_status_update',['id' => $status->id]) }}" method="POST">
                                    {{ csrf_field() }}
                                    <div class="modal-header">
                        ...
                        <div class="modal fade" id="del_modal<?php print "$i" ?>" tabindex="-1" role="dialog" aria-labelledby="label1" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="{{ action('ClientController@client_status_delete',['id' => $status->id]) }}" method="POST">
                                            {{ csrf_field() }}
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">キャンセル</button>
