...
<div class="container">
    <div>
        <span style="font-size: 30px;">取次店編集確認</span>
    </div>
    ...
    <form action="{{ action('TraderController@update') }}" method="POST">
        {{ csrf_field() }}
        <div id="detail_menu">
            <table class="table table-bordered">
                <tr>
                    <th>番号</th>
                    <td class="table-light">{{ $traders['id'] }}</td>
                    <input type="hidden" value="{{ $traders['id'] }}" name="id">
                </tr>
                <tr>
                    <th>紹介者</th>
                ...
                <tr>
                    <th>郵便番号</th>
                    <td class="table-light">{{ $traders['trader_zipcode'] }}</td>
                ...
                <tr>
                    <th>電話番号</th>
                    <td class="table-light">{{ $traders['trader_phone'] }}</td>
                    <input type="hidden" value="{{ $traders['trader_phone'] }}" name="trader_phone">
                </tr>
                <tr>
                    <th>電話番号2</th>
                    <td class="table-light">{{ $traders['trader_phone_2'] }}</td>
                ...
                <tr>
                    <th>契約書タイトル</th>
                    <td class="table-light">{{ $traders['image_title'] }}</td>
                    <input type="hidden" value="{{ $traders['image_title'] }}" name="image_title">
                </tr>
                <tr>
                    <th>契約書画像</th>
                    <td class="table-light"><a href="{{ url($image_path) }}" alt="" style="max-width: 450px; max-height: 450px;">{{ $traders['image_title'] }}</a></td>
