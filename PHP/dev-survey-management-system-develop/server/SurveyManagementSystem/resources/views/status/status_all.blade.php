...
@section('content')
<div>
    <span style="font-size: 30px; margin-left: 60px;">法人案件ステータス編集</span><br>
    <span style="font-size: 20px; margin-left: 60px;"><font color="red">アプリケーションの動作に影響しますので、操作には十分注意願います。</font></span>
</div>
<div class="container">
    @if ($errors->any())
        ...
        <ul class="sub_menu">
            ...
            <div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="label1" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    ...
                    <form action="{{ action('StatusController@matter_status_add') }}" method="POST">
                    {{ csrf_field() }}
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="modal fade" id="upd_modal<?php print "$i" ?>" tabindex="-1" role="dialog" aria-labelledby="label1" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form action="{{ action('StatusController@matter_status_update',['id' => $status->id]) }}" method="POST">
                                    {{ csrf_field() }}
                                    <div class="modal-header">
                        ...
                        <div class="modal fade" id="del_modal<?php print "$i" ?>" tabindex="-1" role="dialog" aria-labelledby="label1" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">キャンセル</button>
                                        <a href="{{ action('StatusController@matter_status_delete',['id' => $status->id]) }}">
